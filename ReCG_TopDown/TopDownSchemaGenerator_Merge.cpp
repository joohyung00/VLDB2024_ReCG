...
bool TopDownSchemaGenerator::mergeToGeneralize()
{
    ...
    else throw IllegalBehaviorError("TopDownSchemaGenerator::mergeToGeneralize - `-1` returned from `mergeInstanceClusters`");
...
void TopDownSchemaGenerator::setInitialDistanceCalculationTargets()
{
