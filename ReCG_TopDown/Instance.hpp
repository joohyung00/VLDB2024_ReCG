...
class InstanceNode : public Node
{
    private:
        ...
        roaring_bitmap_t*   unkleened_labels_childtype_hash_;
        roaring_bitmap_t*   kleened_labels_;
        roaring_bitmap_t*   kleened_childtypes_;
    ...
    public:
        ...
        InstanceNode(InstanceType type, int depth): type_(type), depth_(depth)
        {
            ...
            if(type_ == kObject)
            {
                ...
                unkleened_labels_childtype_hash_   = roaring_bitmap_create();

                kleened_labels_                 = roaring_bitmap_create();
                kleened_childtypes_             = roaring_bitmap_create();
            ...
            else if(type_ == kArray)
            {
                ...
                unkleened_labels_childtype_hash_   = nullptr;
        ...
        roaring_bitmap_t* getLabelChildtypeBitmap()
        { return unkleened_labels_childtype_hash_; }

        roaring_bitmap_t* getKleenedLabels()
        { return kleened_labels_; }

        roaring_bitmap_t* getKleenedChildtypes()
        { return kleened_childtypes_; }
